...
(function() {
	 ...
	 * @return Object
	 */
	var __getById__ = tipJS.getById = function(id, obj){
	 ...
	 * @return Objects
	 */
	var __getByName__ = tipJS.getByName = function(name, obj){
	 ...
	 * @return Objects
	 */
	var __getByTag__ = tipJS.getByTag = function(tag, obj){
	...
	for (var i = _scripts.length; i--;) {
		...
		_match = _scriptSrc.match(/tipJS-MVC-1\.29-dev\.js$/);
		if (_match) {
