/*
 * tipJS - OpenSource Javascript MVC Framework ver.1.30a
 *
...
(function() {
	 ...
	 * @return Object Clone
	 */
	tipJS.cloneObject = function(obj){
	...
	for (var i = _scripts.length; i--;) {
		...
		_match = _scriptSrc.match(/tipJS-MVC-1\.30a-dev\.js$/);
		if (_match) {
