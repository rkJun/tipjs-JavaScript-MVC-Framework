/*
 * tipJS - OpenSource Javascript MVC Framework ver.1.28
 *
...
(function() {
	...
	var __getSeconds__ = function(){
		var _now = new Date();
		return ((_now.now) ? _now.now() : _now.getTime())/1000;
	}
	...
	tipJS.loadApp = function(appNames, params) {
		tipJS.debug("tipJS version " + tipJS.version);
