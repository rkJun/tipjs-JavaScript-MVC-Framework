/*
 * tipJS - OpenSource Javascript MVC Framework ver.1.30
 *
...
(function() {
	...
	tipJS.cloneObject = function(obj){
		...
		for (var k in obj) {
			if (obj[k] && typeof obj[k] == "object") {
				newObj[k] = widgetApp.cloneObj(obj[k]);
			} else {
				newObj[k] = obj[k];
			};
		};
	...
	for (var i = _scripts.length; i--;) {
		...
		_match = _scriptSrc.match(/tipJS-MVC-1\.30-dev\.js$/);
		if (_match) {
